...
#
# # ================= НАЛАШТУВАННЯ =================
# SLIDE_W, SLIDE_H = 640, 480
# GESTURE_DELAY = 1.0
#
# COLORS = [(0, 0, 255), (0, 255, 0), (255, 0, 0)]  # червоний, зелений, синій (BGR)
# color_id = 0
#
# slides_path = "slides"
#
...
#     print("❌ Папка 'slides' не знайдена")
#     exit()
#
# for f in os.listdir(slides_path):
#     path = os.path.join(slides_path, f)
#     img = cv2.imread(path)
#
#     if img is not None:
...
#
# if len(slides) == 0:
#     print("❌ У папці 'slides' немає зображень")
#     exit()
#
# # ================= MediaPipe =================
...
#     print("❌ Папка 'slides' не знайдена або це не папка")
#     exit()
